...
<div class="clearfix"></div>
    ...
    <!-- FOOTER -->
    <footer id="footer">
				<div class="footer-container container hidden-xs hidden-sm hidden-lg hidden-md">

					<div class="row">
						
						<div class="col-md-4 hidden-sm hidden-lg hidden-md">
							<!-- Footer Logo -->
						...
						<div class="col-md-5 hidden-sm hidden-lg hidden-md">
				...
				<div class="copyright hidden-xs">
					<div class="container">
						<ul class="pull-right nomargin list-inline mobile-block1">
							<li><a href="https://haqdarshak.com/terms-and-condition">Terms &amp; Conditions</a></li>
							<!-- <li>&bull;</li>
							<li><a href="#">Privacy&nbsp;Policy </a></li> -->
						</ul>
						© All Rights Reserved, Haqdarshak Empowerment Solutions Private Limited
					</div>
				</div>
...
</div><script type="text/javascript" src="<?php echo base_url('js/bootstrap.js'); ?>"></script><script type="text/javascript" src="<?php echo base_url('js/owl.js'); ?>"></script><script type="text/javascript" src="<?php echo base_url('js/jquery_003.js'); ?>"></script><script type="text/javascript" src="<?php echo base_url('js/select2.js'); ?>"></script><script type="text/javascript" src="<?php echo base_url('js/jquery_002.js'); ?>"></script><script type="text/javascript" src="<?php echo base_url('js/jquery.js'); ?>"></script></body></html>